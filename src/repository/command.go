...
// Insert 新增命令
func Insert(ctx echo.Context) (*mongo.InsertOneResult, string) {
	// 获取集合连接
	collection := Collection(ctx)
...
// InsertBatch 批量新增命令
func InsertBatch(ctx echo.Context) *mongo.InsertManyResult {
	// 获取集合连接
	collection := Collection(ctx)
...
// Update 修改命令
func Update(ctx echo.Context) *mongo.UpdateResult {
	// 获取集合连接
	collection := Collection(ctx)
...
// UpdateBatch 批量修改命令
func UpdateBatch(ctx echo.Context) []*mongo.UpdateResult {
	// 获取集合连接
	collection := Collection(ctx)

	// 获取请求体参数
	var commandArray []model.Command
	errBind := ctx.Bind(&commandArray)
	if errBind != nil {
		log.Println(errBind)
	}
...
// Delete 删除命令
func Delete(ctx echo.Context) (*mongo.DeleteResult, primitive.ObjectID) {
	// 获取集合连接
	collection := Collection(ctx)
...
// DeleteBatch 批量删除命令
func DeleteBatch(ctx echo.Context) (*mongo.DeleteResult, []primitive.ObjectID) {
	// 获取集合连接
	collection := Collection(ctx)
...
// Select 查询命令
func Select(ctx echo.Context) model.Command {
	// 获取集合连接
	collection := Collection(ctx)
...
// NameList 查询命令名称列表
func NameList(ctx echo.Context) []string {
	// 获取集合连接
	collection := Collection(ctx)
